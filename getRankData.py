...
summonerNames = ['joshpaulie','mltsimpleton','poydok','boxrog','artificialmeat','roninalex','cradmajone','grillmasterlou','darthmrow','atoxichobo','ectoplax','vynle']
