...
from getRankData import PullSummonerData
from randomKanye import generateInspiration
from timestamp import createtimestamp
...
async def on_message(message):
    ...
    if message.content.startswith('g.hello'):
        ...
        print("- {} issued the hello command at {}".format(message.author.name, createtimestamp()))

    if message.content.startswith('g.yo'):
        await message.channel.send("```what's up gamer?```")
        print("- {} issued the yo command at {}".format(message.author.name, createtimestamp()))

    if message.content.startswith('g.rank'):
        print("Rank Pulled!")
        await message.channel.send("```Pulling data... 🤖```")
        await message.channel.send(PullSummonerData())
        print("- {} issued the rank command at {}".format(message.author.name, createtimestamp()))
    ...
    if message.content.startswith('g.fword'):
        print(" - {} issued the fword command at {}".format(message.author.name, createtimestamp()))
        await message.channel.send(
    ...
    if message.content.startswith('g.squad'):
        print(" - {} issued the squad command at {}".format(message.author.name, createtimestamp()))
        await message.channel.send(
    ...
    if message.content.startswith('g.bringe'):
        print(" - {} issued the bringe command at {}".format(message.author.name, createtimestamp()))
        await message.channel.send(
    ...
    if message.content.startswith("g.paypig"):
        print(" - {} issued the paypig command at {}".format(message.author.name, createtimestamp()))
        await message.channel.send("https://www.twitch.tv/dekar173")

    if message.content.startswith("g.pecs"):
        print(" - {} issued the pecs command at {}".format(message.author.name, createtimestamp()))
        await message.channel.send(
    ...
    if message.content.startswith("g.quads"):
        print(" - {} issued the quads command at {}".format(message.author.name, createtimestamp()))
        await message.channel.send(
    ...
    if message.content.startswith("g.kanye"):
        print(" - {} issued the kanye command at {}".format(message.author.name, createtimestamp()))
        await message.channel.send(generateInspiration())

    if message.content.startswith("g.whiskeyrad"):
        print(" - {} issued the whiskeyrad command at {}".format(message.author.name, createtimestamp()))
        await message.channel.send(
